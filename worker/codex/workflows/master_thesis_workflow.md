...
Use this workflow when `extracted/order_profile.json` has `profile_key=master_thesis`.
...
Verify faculty, advisor, title, degree, methodology, quantity, language, citation style, and supplied files/references.
...
Extract thesis formatting, chapter, abstract, source, disclosure, and final-file rules.

## 3. Literature And Visual Sources
...
Use source-grounded summaries only. Flag missing data, results, or student analysis.
...
Plan chapters around problem, literature, method, findings placeholder, and conclusion. Do not fabricate research findings.
...
Keep every claim traceable. Use placeholders for missing original research material.

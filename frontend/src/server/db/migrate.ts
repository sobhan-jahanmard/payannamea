...
const statements = [
  ...
  `alter table orders alter column status type varchar(64)`,
  ...
  `alter table order_status_logs alter column from_status type varchar(64)`,
  `alter table order_status_logs alter column to_status type varchar(64)`,
  `update order_status_logs set from_status = 'sample_pending_customer_approval' where from_status = 'sample_revision_required'`,
  `update order_status_logs set to_status = 'sample_pending_customer_approval' where to_status = 'sample_revision_required'`,
  `update order_status_logs set from_status = 'approved_pending_for_final_execution' where from_status = 'full_approved'`,
  `update order_status_logs set to_status = 'approved_pending_for_final_execution' where to_status = 'full_approved'`,

...
2) برای نمونه: چکیده، کلیدواژه‌ها، مقدمه یا بیان مسئله، بخشی مستدل از مبانی یا امکان‌سنجی، روش و محدودیت‌ها، جمع‌بندی و «# منابع» را بساز. برای نسخه کامل، همه فصل‌های لازم را با همان منطق بساز.
